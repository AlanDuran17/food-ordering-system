...
import order.service.dataaccess.restaurant.repository.RestaurantJpaRepository;
...
public class RestaurantRepositoryImpl implements RestaurantRepository {
    ...
    public Optional<Restaurant> findRestaurantInformation(Restaurant restaurant) {
        ...
        Optional<List<RestaurantEntity>> restaurantEntities = repository
                .findByRestaurantIdAndProductId(restaurant.getId().getValue(), restaurantProducts);
