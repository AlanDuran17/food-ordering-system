package com.alanduran.order.service.domain.outbox.scheduler.payment;
...
public class PaymentOutboxHelper {
    ...
    private String createPayload(OrderPaymentEventPayload paymentEventPayload) {
        try {
            ...
            log.error("Could not create OrderPaymentOutboxMessage object for order id: {}", paymentEventPayload.getOrderId(), e);
            throw new OrderDomainException("Could not create OrderPaymentOutboxMessage object for order id: " + paymentEventPayload.getOrderId());
        }
    }
}
