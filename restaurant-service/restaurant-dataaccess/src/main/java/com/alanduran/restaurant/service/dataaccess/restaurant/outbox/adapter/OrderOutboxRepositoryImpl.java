package com.alanduran.restaurant.service.dataaccess.restaurant.outbox.adapter;

import com.alanduran.outbox.OutboxStatus;
import com.alanduran.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import com.alanduran.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import com.alanduran.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import com.alanduran.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import com.alanduran.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
