package com.alanduran.kafka.consumer.config;

import com.alanduran.kafka.config.data.KafkaConfigData;
import com.alanduran.kafka.config.data.KafkaConsumerConfigData;
